...
abstract class User implements ActiveRecordInterface
{
    ...
    /**
     * @var        ObjectCollection|ChildBlog[] Collection to store aggregation of ChildBlog objects.
     */
    protected $collBlogs;
     ...
     * @var ObjectCollection|ChildBlog[]
     */
    ...
    public function setUserpassword($v)
    {
        ...
        if ($this->userpassword !== $v) {
            $this->userpassword = $v;
            $this->modifiedColumns[UserTableMap::COL_USERPASSWORD] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $this->userpassword = (null !== $col) ? (string) $col : null;
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->blogsScheduledForDeletion !== null) {
                if (!$this->blogsScheduledForDeletion->isEmpty()) {
                    \BlogQuery::create()
                        ->filterByPrimaryKeys($this->blogsScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_USERPASSWORD)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->collBlogs) {
                ...
                $result[$key] = $this->collBlogs->toArray(null, false, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_USERPASSWORD)) {
            $criteria->add(UserTableMap::COL_USERPASSWORD, $this->userpassword);
        }
        if ($this->isColumnModified(UserTableMap::COL_USERROLE)) {
    ...
    public function initBlogs($overrideExisting = true)
    {
        ...
        $this->collBlogs = new ObjectCollection();
        $this->collBlogs->setModel('\Blog');
    }

    /**
     * Gets an array of ChildBlog objects which contain a foreign key that references this object.
     *
     ...
     * @return ObjectCollection|ChildBlog[] List of ChildBlog objects
     * @throws PropelException
     */
    public function getBlogs(Criteria $criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collBlogs || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collBlogs) {
                ...
                $collBlogs = ChildBlogQuery::create(null, $criteria)
                    ->filterByUser($this)
                    ->find($con);
    ...
    /**
     * Sets a collection of ChildBlog objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param      Collection $blogs A Propel collection.
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildUser The current object (for fluent API support)
     */
    public function setBlogs(Collection $blogs, ConnectionInterface $con = null)
    {
        /** @var ChildBlog[] $blogsToDelete */
        ...
        $this->blogsScheduledForDeletion = clone $blogsToDelete;

        foreach ($blogsToDelete as $blogRemoved) {
            $blogRemoved->setUser(null);
        }
     ...
     * @throws PropelException
     */
    public function countBlogs(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collBlogsPartial && !$this->isNew();
        if (null === $this->collBlogs || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collBlogs) {
            ...
            $query = ChildBlogQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a ChildBlog object to this object
     * through the ChildBlog foreign key attribute.
     *
     * @param  ChildBlog $l ChildBlog
     * @return $this|\User The current object (for fluent API support)
     */
    public function addBlog(ChildBlog $l)
    {
        if ($this->collBlogs === null) {
            $this->initBlogs();
            $this->collBlogsPartial = true;
    ...
    /**
     * @param ChildBlog $blog The ChildBlog object to add.
     */
    protected function doAddBlog(ChildBlog $blog)
    {
        $this->collBlogs[]= $blog;
        $blog->setUser($this);
    }
    ...
    /**
     * @param  ChildBlog $blog The ChildBlog object to remove.
     * @return $this|ChildUser The current object (for fluent API support)
     */
    public function removeBlog(ChildBlog $blog)
    {
        if ($this->getBlogs()->contains($blog)) {
            $pos = $this->collBlogs->search($blog);
            $this->collBlogs->remove($pos);
            ...
            $this->blogsScheduledForDeletion[]= clone $blog;
            $blog->setUser(null);
        }
