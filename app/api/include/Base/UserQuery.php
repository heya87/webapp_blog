 ...
 * @method     ChildUserQuery orderByUserpassword($order = Criteria::ASC) Order by the UserPassword column
 ...
 * @method     ChildUserQuery groupByUserpassword() Group by the UserPassword column
 ...
 *
 * @method     ChildUserQuery leftJoinBlog($relationAlias = null) Adds a LEFT JOIN clause to the query using the Blog relation
 * @method     ChildUserQuery rightJoinBlog($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Blog relation
 * @method     ChildUserQuery innerJoinBlog($relationAlias = null) Adds a INNER JOIN clause to the query using the Blog relation
 *
 ...
 *
 * @method     \BlogQuery|\CommentQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildUser findOneByUserpassword(string $UserPassword) Return the first ChildUser filtered by the UserPassword column
 * @method     ChildUser findOneByUserrole(string $UserRole) Return the first ChildUser filtered by the UserRole column *
 ...
 * @method     ChildUser requireOneByUserpassword(string $UserPassword) Return the first ChildUser filtered by the UserPassword column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildUser[]|ObjectCollection findByUserpassword(string $UserPassword) Return ChildUser objects filtered by the UserPassword column
...
abstract class UserQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT idUser, UserName, UserPassword, UserRole FROM User WHERE idUser = :p0';
        try {
     ...
     * $query->filterByUserpassword('%fooValue%'); // WHERE UserPassword LIKE '%fooValue%'
     * </code>
     *
    ...
    public function filterByUserpassword($userpassword = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UserTableMap::COL_USERPASSWORD, $userpassword, $comparison);
    }
     ...
     * $query->filterByUserrole('%fooValue%'); // WHERE UserRole LIKE '%fooValue%'
     * </code>
     *
     ...
     *
     * @param \Blog|ObjectCollection $blog the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    public function filterByBlog($blog, $comparison = null)
    {
        if ($blog instanceof \Blog) {
            return $this
                ->addUsingAlias(UserTableMap::COL_IDUSER, $blog->getUserIduser(), $comparison);
    ...
    public function filterByComment($comment, $comparison = null)
    {
        if ($comment instanceof \Comment) {
            return $this
                ->addUsingAlias(UserTableMap::COL_IDUSER, $comment->getUserIduser(), $comparison);
