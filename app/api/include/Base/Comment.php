...
abstract class Comment implements ActiveRecordInterface
{
    ...
    /**
     * The value for the idcomment field.
     * @var        int
     */
    protected $idcomment;
    ...
    /**
     * The value for the post_idpost field.
     * @var        int
     */
    protected $post_idpost;
    ...
    /**
     * Get the [idcomment] column value.
     *
     * @return int
     */
    ...
    /**
     * Get the [post_idpost] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [idcomment] column.
     *
    ...
    public function setIdcomment($v)
    {
        ...
        if ($this->idcomment !== $v) {
            $this->idcomment = $v;
            $this->modifiedColumns[CommentTableMap::COL_IDCOMMENT] = true;
        }
    ...
    public function setDatetime($v)
    {
        ...
        if ($this->datetime !== null || $dt !== null) {
            if ($this->datetime === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->datetime->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[CommentTableMap::COL_DATETIME] = true;
            }
    ...
    public function setUserIduser($v)
    {
        ...
        if ($this->user_iduser !== $v) {
            $this->user_iduser = $v;
            $this->modifiedColumns[CommentTableMap::COL_USER_IDUSER] = true;
        }
    ...
    /**
     * Set the value of [post_idpost] column.
     *
     * @param int $v new value
     * @return $this|\Comment The current object (for fluent API support)
     */
    public function setPostIdpost($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->post_idpost !== $v) {
            $this->post_idpost = $v;
            $this->modifiedColumns[CommentTableMap::COL_POST_IDPOST] = true;
        }

        if ($this->aPost !== null && $this->aPost->getIdpost() !== $v) {
            $this->aPost = null;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CommentTableMap::translateFieldName('Idcomment', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idcomment = (null !== $col) ? (int) $col : null;
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CommentTableMap::translateFieldName('Datetime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->datetime = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CommentTableMap::translateFieldName('UserIduser', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_iduser = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CommentTableMap::translateFieldName('PostIdpost', TableMap::TYPE_PHPNAME, $indexType)];
            $this->post_idpost = (null !== $col) ? (int) $col : null;
            $this->resetModified();
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aPost !== null && $this->post_idpost !== $this->aPost->getIdpost()) {
            $this->aPost = null;
        }
    } // ensureConsistency
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CommentTableMap::COL_IDCOMMENT)) {
            $modifiedColumns[':p' . $index++]  = 'idComment';
        }
        if ($this->isColumnModified(CommentTableMap::COL_TEXT)) {
            $modifiedColumns[':p' . $index++]  = 'Text';
        }
        if ($this->isColumnModified(CommentTableMap::COL_DATETIME)) {
            $modifiedColumns[':p' . $index++]  = 'DateTime';
        }
        if ($this->isColumnModified(CommentTableMap::COL_USER_IDUSER)) {
            $modifiedColumns[':p' . $index++]  = 'User_idUser';
        }
        if ($this->isColumnModified(CommentTableMap::COL_POST_IDPOST)) {
            $modifiedColumns[':p' . $index++]  = 'Post_idPost';
        }
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'idComment':
                        $stmt->bindValue($identifier, $this->idcomment, PDO::PARAM_INT);
                        break;
                    case 'Text':
                    ...
                    case 'User_idUser':
                        ...
                        break;
                    case 'Post_idPost':
                        $stmt->bindValue($identifier, $this->post_idpost, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommentTableMap::COL_IDCOMMENT)) {
            $criteria->add(CommentTableMap::COL_IDCOMMENT, $this->idcomment);
        }
        if ($this->isColumnModified(CommentTableMap::COL_TEXT)) {
            $criteria->add(CommentTableMap::COL_TEXT, $this->text);
        }
        if ($this->isColumnModified(CommentTableMap::COL_DATETIME)) {
            $criteria->add(CommentTableMap::COL_DATETIME, $this->datetime);
        }
        if ($this->isColumnModified(CommentTableMap::COL_USER_IDUSER)) {
            $criteria->add(CommentTableMap::COL_USER_IDUSER, $this->user_iduser);
        }
        if ($this->isColumnModified(CommentTableMap::COL_POST_IDPOST)) {
            $criteria->add(CommentTableMap::COL_POST_IDPOST, $this->post_idpost);
        }
    ...
    public function hashCode()
    {
        $validPk = null !== $this->getIdcomment() &&
            ...
            null !== $this->getPostIdpost();

        $validPrimaryKeyFKs = 2;
        $primaryKeyFKs = [];

        //relation fk_Comment_Post1 to table Post
        ...
        //relation fk_Comment_User1 to table User
    ...
    {
        $pks = array();
        $pks[0] = $this->getIdcomment();
        $pks[1] = $this->getUserIduser();
        $pks[2] = $this->getPostIdpost();
    ...
    {
        $this->setIdcomment($keys[0]);
        $this->setUserIduser($keys[1]);
        $this->setPostIdpost($keys[2]);
    }
    ...
    {
        return (null === $this->getIdcomment()) && (null === $this->getUserIduser()) && (null === $this->getPostIdpost());
    }
    ...
    {
        if ($v === null) {
            $this->setPostIdpost(NULL);
        } else {
            $this->setPostIdpost($v->getIdpost());
        }
    ...
    {
        if ($this->aPost === null && ($this->post_idpost !== null)) {
