...
abstract class Image implements ActiveRecordInterface
{
    ...
    /**
     * The value for the idimage field.
     * @var        int
     */
    protected $idimage;
    ...
    /**
     * Set the value of [idimage] column.
     *
    ...
    public function setIdimage($v)
    {
        ...
        if ($this->idimage !== $v) {
            $this->idimage = $v;
            $this->modifiedColumns[ImageTableMap::COL_IDIMAGE] = true;
        }
    ...
    public function setUrl($v)
    {
        ...
        if ($this->url !== $v) {
            $this->url = $v;
            $this->modifiedColumns[ImageTableMap::COL_URL] = true;
        }
    ...
    public function setPostIdpost($v)
    {
        ...
        if ($this->post_idpost !== $v) {
            $this->post_idpost = $v;
            $this->modifiedColumns[ImageTableMap::COL_POST_IDPOST] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ImageTableMap::translateFieldName('Idimage', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idimage = (null !== $col) ? (int) $col : null;
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ImageTableMap::translateFieldName('Url', TableMap::TYPE_PHPNAME, $indexType)];
            $this->url = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ImageTableMap::translateFieldName('PostIdpost', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = ImageTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ImageTableMap::COL_IDIMAGE)) {
            $modifiedColumns[':p' . $index++]  = 'idImage';
        }
        if ($this->isColumnModified(ImageTableMap::COL_TITLE)) {
            $modifiedColumns[':p' . $index++]  = 'Title';
        }
        if ($this->isColumnModified(ImageTableMap::COL_URL)) {
            $modifiedColumns[':p' . $index++]  = 'url';
        }
        if ($this->isColumnModified(ImageTableMap::COL_POST_IDPOST)) {
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'idImage':
                        $stmt->bindValue($identifier, $this->idimage, PDO::PARAM_INT);
                        break;
                    case 'Title':
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ImageTableMap::COL_IDIMAGE)) {
            $criteria->add(ImageTableMap::COL_IDIMAGE, $this->idimage);
        }
        if ($this->isColumnModified(ImageTableMap::COL_TITLE)) {
            $criteria->add(ImageTableMap::COL_TITLE, $this->title);
        }
        if ($this->isColumnModified(ImageTableMap::COL_URL)) {
            $criteria->add(ImageTableMap::COL_URL, $this->url);
        }
        if ($this->isColumnModified(ImageTableMap::COL_POST_IDPOST)) {
            $criteria->add(ImageTableMap::COL_POST_IDPOST, $this->post_idpost);
        }
    ...
    {
        $validPk = null !== $this->getIdimage() &&
            null !== $this->getPostIdpost();

        $validPrimaryKeyFKs = 1;
        $primaryKeyFKs = [];

        //relation fk_Image_Post1 to table Post
    ...
    {
        $pks = array();
        $pks[0] = $this->getIdimage();
        $pks[1] = $this->getPostIdpost();
    ...
    {
        $this->setIdimage($keys[0]);
        $this->setPostIdpost($keys[1]);
    }
    ...
    {
        return (null === $this->getIdimage()) && (null === $this->getPostIdpost());
    }
