 ...
 * @method     ChildFeatureQuery orderByName($order = Criteria::ASC) Order by the name column
 * @method     ChildFeatureQuery orderByDescription($order = Criteria::ASC) Order by the description column
 *
 * @method     ChildFeatureQuery groupById() Group by the id column
 * @method     ChildFeatureQuery groupByName() Group by the name column
 * @method     ChildFeatureQuery groupByDescription() Group by the description column
 *
 ...
 * @method     ChildFeature findOneByName(string $name) Return the first ChildFeature filtered by the name column
 * @method     ChildFeature findOneByDescription(string $description) Return the first ChildFeature filtered by the description column *
 ...
 *
 * @method     ChildFeature requireOneById(int $id) Return the first ChildFeature filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildFeature requireOneByName(string $name) Return the first ChildFeature filtered by the name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildFeature requireOneByDescription(string $description) Return the first ChildFeature filtered by the description column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildFeature[]|ObjectCollection findById(int $id) Return ChildFeature objects filtered by the id column
 * @method     ChildFeature[]|ObjectCollection findByName(string $name) Return ChildFeature objects filtered by the name column
 * @method     ChildFeature[]|ObjectCollection findByDescription(string $description) Return ChildFeature objects filtered by the description column
...
abstract class FeatureQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'default', $modelName = '\\Feature', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name, description FROM feature WHERE id = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(FeatureTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(FeatureTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(FeatureTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(FeatureTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(FeatureTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(FeatureTableMap::COL_NAME, $name, $comparison);
    }
    ...
    public function filterByDescription($description = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(FeatureTableMap::COL_DESCRIPTION, $description, $comparison);
    }
    ...
    {
        if ($feature) {
            $this->addUsingAlias(FeatureTableMap::COL_ID, $feature->getId(), Criteria::NOT_EQUAL);
        }
