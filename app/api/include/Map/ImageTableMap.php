...
class ImageTableMap extends TableMap
{
    ...
    /**
     * the column name for the idImage field
     */
    const COL_IDIMAGE = 'Image.idImage';

    /**
     * the column name for the Title field
     */
    const COL_TITLE = 'Image.Title';

    /**
     * the column name for the url field
     */
    const COL_URL = 'Image.url';

    /**
     * the column name for the Post_idPost field
     */
    const COL_POST_IDPOST = 'Image.Post_idPost';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Idimage', 'Title', 'Url', 'PostIdpost', ),
        self::TYPE_CAMELNAME     => array('idimage', 'title', 'url', 'postIdpost', ),
        self::TYPE_COLNAME       => array(ImageTableMap::COL_IDIMAGE, ImageTableMap::COL_TITLE, ImageTableMap::COL_URL, ImageTableMap::COL_POST_IDPOST, ),
        self::TYPE_FIELDNAME     => array('idImage', 'Title', 'url', 'Post_idPost', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Idimage' => 0, 'Title' => 1, 'Url' => 2, 'PostIdpost' => 3, ),
        self::TYPE_CAMELNAME     => array('idimage' => 0, 'title' => 1, 'url' => 2, 'postIdpost' => 3, ),
        self::TYPE_COLNAME       => array(ImageTableMap::COL_IDIMAGE => 0, ImageTableMap::COL_TITLE => 1, ImageTableMap::COL_URL => 2, ImageTableMap::COL_POST_IDPOST => 3, ),
        self::TYPE_FIELDNAME     => array('idImage' => 0, 'Title' => 1, 'url' => 2, 'Post_idPost' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('idImage', 'Idimage', 'INTEGER', true, null, null);
  ...
  array (
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (null === $key) {
                $key = serialize(array((string) $obj->getIdimage(), (string) $obj->getPostIdpost()));
            } // if key === null
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Image) {
                $key = serialize(array((string) $value->getIdimage(), (string) $value->getPostIdpost()));
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Idimage', TableMap::TYPE_PHPNAME, $indexType)] === null && $row[TableMap::TYPE_NUM == $indexType ? 3 + $offset : static::translateFieldName('PostIdpost', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return serialize(array((string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Idimage', TableMap::TYPE_PHPNAME, $indexType)], (string) $row[TableMap::TYPE_NUM == $indexType ? 3 + $offset : static::translateFieldName('PostIdpost', TableMap::TYPE_PHPNAME, $indexType)]));
    }
    ...
    public static function getPrimaryKeyFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        $pks[] = (int) $row[
            $indexType == TableMap::TYPE_NUM
                ? 0 + $offset
                : self::translateFieldName('Idimage', TableMap::TYPE_PHPNAME, $indexType)
        ];
        $pks[] = (int) $row[
            $indexType == TableMap::TYPE_NUM
                ? 3 + $offset
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ImageTableMap::COL_IDIMAGE);
            $criteria->addSelectColumn(ImageTableMap::COL_TITLE);
            $criteria->addSelectColumn(ImageTableMap::COL_URL);
            $criteria->addSelectColumn(ImageTableMap::COL_POST_IDPOST);
        } else {
            $criteria->addSelectColumn($alias . '.idImage');
     ...
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(ImageTableMap::COL_IDIMAGE, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(ImageTableMap::COL_POST_IDPOST, $value[1]));
