...
class FeatureTableMap extends TableMap
{
     ...
     */
    const COL_ID = 'feature.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'feature.name';

    /**
     * the column name for the description field
     */
    const COL_DESCRIPTION = 'feature.description';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(FeatureTableMap::COL_ID, FeatureTableMap::COL_NAME, FeatureTableMap::COL_DESCRIPTION, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(FeatureTableMap::COL_ID => 0, FeatureTableMap::COL_NAME => 1, FeatureTableMap::COL_DESCRIPTION => 2, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(FeatureTableMap::COL_ID);
            $criteria->addSelectColumn(FeatureTableMap::COL_NAME);
            $criteria->addSelectColumn(FeatureTableMap::COL_DESCRIPTION);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(FeatureTableMap::COL_ID, (array) $values, Criteria::IN);
        }
